...
Define the actual values for these variables in the terraform.tfvars file.<br>
Ensure that the IAM policy allows only read access and restricts it to the specific DynamoDB table created.<br>
